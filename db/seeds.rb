...
Workout.create(title: "Crunches", body: "abdominal", category: "body weight", reps: 10, sets: 5, time: "10 minutes", instructions: "1. Lie down on your back.
...
Comment.create(content:"I love doing crunches after a nice hard workout.", workout: workout_one, user: user_one)
Comment.create(content:"This is a great exercise.", workout: workout_one, user: user_two)
Comment.create(content:"I rather do cardio.", workout: workout_one, user: user_three)

Workout.create(title: "Squats", body: "legs", category: "body weight", reps: 10, sets: 5, time: "10 minutes", instructions: "1. Stand facing forward with your chest up.
...
Comment.create(content:"This is a great exercise to do while at home. Highly recommend!", workout: workout_one, user: user_one)
Comment.create(content:"I used to do about 300 hundred a day when I was still in the WWE. The more it burns, the more effective!", workout: workout_one, user: user_two)
Comment.create(content:"This is an essential exercise and is in at least one of my WODs each week!", workout: workout_one, user: user_three)
...
Comment.create(content:"Great workout for legs at home!", workout: workout_one, user: user_one)
Comment.create(content:"I usually like to hold a heavy medicine ball over my head while I do this to feel the extra burn!", workout: workout_one, user: user_two)
Comment.create(content:"I do enough cardio to not have to do these! Gotta love crossfit!", workout: workout_one, user: user_three)
...
Comment.create(content:"Great workout for legs at home!", workout: workout_one, user: user_one)
Comment.create(content:"I usually like to hold a heavy medicine ball over my head while I do this to feel the extra burn!", workout: workout_one, user: user_two)
Comment.create(content:"I incorporate this exercise into all my WODs!", workout: workout_one, user: user_three)
...
Comment.create(content:"Not a big fan of planks. I'm a burpee kinda guy.", workout: workout_one, user: user_three)

Workout.create(title: "Burpee", body: "legs", category: "body weight", reps: 10, sets: 5, time: "25 minutes", instructions: "1. Begin in a squat position with hands on the floor, slightly wider than shoulder width.
...
Comment.create(content:"I prefer to lift weights but this is a great cardio that burns a lot of calories.", workout: workout_one, user: user_one)
Comment.create(content:"I rather do my own stunts than do burpees!", workout: workout_one, user: user_two)
Comment.create(content:"IMO, this is the most effective exercise. I love it!", workout: workout_one, user: user_three)
